  ...
  if (!rows || rows.length === 0) {
    const capabilities = [
      ...
      // keep an invalid claim that becomes live the moment someone imports it.
        // Not replaced with other statistics. This is the DEV-ONLY lab copy
      // (`_lab` routes are import.meta.env.DEV-guarded in App.tsx), cleaned so
      // an unsupported claim cannot graduate into production by being copied
      // back out of the lab.

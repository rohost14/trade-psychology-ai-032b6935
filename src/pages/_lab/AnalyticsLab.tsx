/**
 * DESIGN LAB — working copy of Analytics. Route: /analytics-lab
 *
 * The real page and its components are untouched; only tabs actually being
 * restructured are forked into ./analytics/, the rest import the originals so
 * the lab cannot drift on code nobody is redesigning.
 *
 * Delete this directory once a direction is chosen and ported.
 */
...
const OverviewTab  = lazy(() => import('./analytics/OverviewLab'));

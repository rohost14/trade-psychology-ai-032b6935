 ...
 *
 * Account erasure only — Privacy Policy §12 / DPDP Act 2023 right to be forgotten.
 *
 * Import and export moved to Settings → Data. They are routine data-portability
 * operations, and keeping them here meant the most useful action for a new user
 * (importing their history, without which Analytics stays empty) was filed one row
 * above "Delete your account". A tab called Danger Zone should contain exactly the
    ...
    return (
      <div className="tm-card px-5 py-8 text-center">
        ...
        <p className="text-[13px] text-muted-foreground mt-1 max-w-sm mx-auto">
          Account deletion acts on a real connected account.
          Connect your Zerodha account to use it.
        </p>
      </div>
    );
  }
        ...
        <div className="p-5 space-y-4">
          <div className="rounded-lg border border-tm-loss/30 bg-red-50/40 dark:bg-red-900/10 px-4 py-3">
            ...
            <p className="text-[12px] text-muted-foreground mt-2">
              Your trade records at Zerodha are unaffected. Consider exporting your data
              first — Settings → Data.
            </p>
          </div>

...
import {
  ...
  RefreshCw, Brain, ChevronRight, Zap,
} from 'lucide-react';
...
export function InsightsTab() {
  ...
  return (
    <div className="space-y-5">
      {/* Sub-header with last-updated and refresh */}
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-foreground">Personalized Pattern Insights</p>
          {data?.last_updated && (
      ...
      {learnError && (
        <div className="px-4 py-3 rounded-lg bg-tm-loss/10 border border-tm-loss/20 text-sm text-tm-loss">
          {learnError}
        </div>
      )}

...
import {
  ...
  DEMO_INSTRUMENT_NIFTY, DEMO_EDGE_LEAK, DEMO_STRATEGY_PERFORMANCE, DEMO_HABITS, DEMO_SESSION_LOG, DEMO_BEHAVIOUR_COST, DEMO_ALERT_RESPONSE_STATS, DEMO_SAVED_REPORTS, DEMO_JOURNAL_ENTRIES,

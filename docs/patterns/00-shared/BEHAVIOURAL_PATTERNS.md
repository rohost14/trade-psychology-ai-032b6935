...
**Reviewed: 20 of the 27, as of 30 Aug 2026 — see the REVIEW STATUS table
...
| **21** | **`opening_5min_trap` (§19)** | **NEXT** | — | — | Three windows in one detector, analytics-only, and now **the last INFO detector with no reader** alongside `rapid_reentry` |
